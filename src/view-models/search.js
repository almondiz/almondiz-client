...
export default class SearchViewModel {
  ...
  async searchFullTag(keyword) {
    ...
    return this._getDummyFullTagResult();
  }
  _getDummyFullTagResult() {
    return {
      foods: [
  ...
  async readSearchHistory() {
    ...
    return this._getDummySearchHistory();
  }
  _getDummySearchHistory() {
    return [
      [
  ...
  async searchShop(keyword) {
    ...
    return this._getDummyShopResult();
  }
  _getDummyShopResult() {
  ...
  async searchPlace(keyword) {
    ...
    return this._getDummyPlaceResult();
  }
  _getDummyPlaceResult() {
    return [
      {
        placeId: 1,
        placeName: "아주대학교",
